...
The addon is also available on the Odoo Apps store (https://apps.odoo.com/apps/modules/18.0/payment_taler).
...
<img src="README_Pictures/EN/Taler_ecommerce_wallet.png" alt="Taler eCommerce wallet" width="300px">
