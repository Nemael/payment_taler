...
After a few hours of trial-and-error, I managed to make it work, and after installing Odoo, I use the command `./odoo-bin --addons-path=./addons,/media/sf_VMSharedFolders/custom_addons -u payment_taler -d odoo18_tops_0.1.1.1` to start Odoo
