...
I am not sure yet how I should present this. Should I make a very big README file, with all the info and the pictures? Or should I make a second or multiple files specifically for tutorials?
The same question will rise when I will make a French translation for the README files. Should I put the French version below the English version (It feels bad to put them in an order of importance)? Or should I create multiple README files, one for each language (The users reading the code might not find the proper READMEs)
