...
class TalerInvoicing(models.Model):
    ...
    #I probably can remove this provider_id field
    ...
    def action_post(self):
        ...
        for move in self:
            ...
            if move.move_type in ('out_invoice', 'in_invoice') and move.preferred_payment_method_line_id.name == "Taler":  # only invoices/bills
