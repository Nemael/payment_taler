...
class Student(models.Model):
    ...
    def postPlaceOrder(self):
        ...
        self.order_last_order_url = merchant_url + "/orders/" + self.order_latest_order_id

    def getOrderTalerUri(self):
        merchant_url = self.env['ir.config_parameter'].sudo().get_param('tops.merchant_url', default='')
        url = merchant_url + "/private/orders/" + self.order_latest_order_id
